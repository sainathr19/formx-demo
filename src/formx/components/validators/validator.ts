...
const checkMinimumNumber = (num : number, minNumber : number) => {
    return num>=minNumber
}
const checkMaximumNumber = (num : number, maxNumber : number) => {
...
export { checkMaximumNumber, checkMinimumNumber, hasMaximumLen, hasMinimumLen, isEmail, isEmpty, isMatch, validateField };
